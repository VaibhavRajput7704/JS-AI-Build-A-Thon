...
exports.convertCreateAgentOptions = convertCreateAgentOptions;
exports.convertVectorStoreDataSource = convertVectorStoreDataSource;
exports.convertUpdateAgentOptions = convertUpdateAgentOptions;
exports.convertAgentThreadCreationOptions = convertAgentThreadCreationOptions;
exports.convertAgentThreadUpdateOptions = convertAgentThreadUpdateOptions;
exports.convertCreateRunOptions = convertCreateRunOptions;
exports.convertToolOutput = convertToolOutput;
exports.convertCreateAndRunThreadOptions = convertCreateAndRunThreadOptions;
exports.convertVectorStoreOptions = convertVectorStoreOptions;
exports.convertVectorStoreChunkingStrategyRequest = convertVectorStoreChunkingStrategyRequest;
exports.convertVectorStoreUpdateOptions = convertVectorStoreUpdateOptions;
// Conversion functions
function convertCreateAgentOptions(source) {
...
function convertVectorStoreDataSource(source) {
    return {
        uri: source.uri,
        type: source.type,
    };
...
function convertAgentThreadCreationOptions(source) {
...
function convertAgentThreadUpdateOptions(source) {
...
function convertCreateRunOptions(source) {
...
function convertToolOutput(source) {
...
function convertCreateAndRunThreadOptions(source) {
...
function convertVectorStoreOptions(source) {
...
function convertVectorStoreChunkingStrategyRequest(source) {
    switch (source.type) {
        case "auto":
            return source;
        case "static":
...
function convertVectorStoreUpdateOptions(source) {
