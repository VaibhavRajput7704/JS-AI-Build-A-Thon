 ...
 */
export function isOutputOfType(output, type) {
    return output.type === type;
}
/** Types of connection tools used to configure an agent */
export var connectionToolType;
