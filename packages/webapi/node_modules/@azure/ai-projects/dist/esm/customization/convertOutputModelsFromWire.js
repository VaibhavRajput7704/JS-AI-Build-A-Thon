...
export function convertAgentOutput(input) {
    var _a;
    return {
        id: input.id,
        object: input.object,
...
export function convertAgentDeletionStatusOutput(input) {
    return Object.assign({}, input);
}
...
export function convertAgentThreadOutput(input) {
    return {
        id: input.id,
        object: input.object,
        createdAt: new Date(input.created_at),
...
export function convertThreadDeletionStatusOutput(input) {
    return Object.assign({}, input);
}
export function convertThreadMessageOutput(input) {
    var _a, _b;
    return {
        id: input.id,
        object: input.object,
...
export function convertThreadRunOutput(input) {
    var _a, _b;
...
export function convertOpenAIPageableListOfThreadRunOutput(input) {
    var _a;
    return {
        object: input.object,
        firstId: input.first_id,
...
export function convertRunStepOutput(input) {
...
export function convertOpenAIPageableListOfRunStepOutput(input) {
    var _a;
    return {
        object: input.object,
        firstId: input.first_id,
...
export function convertOpenAIPageableListOfThreadMessageOutput(input) {
    var _a;
    return {
        object: input.object,
        firstId: input.first_id,
...
export function convertOpenAIPageableListOfAgentThreadOutput(input) {
    var _a;
    return {
        object: input.object,
        firstId: input.first_id,
...
export function convertOpenAIPageableListOfVectorStoreOutput(input) {
    return {
        object: input.object,
        firstId: input.first_id,
        lastId: input.last_id,
...
export function convertVectorStoreOutput(input) {
    return {
        id: input.id,
        object: input.object,
        createdAt: new Date(input.created_at),
...
export function convertVectorStoreDeletionStatusOutput(input) {
    return {
        id: input.id,
...
export function convertVectorStoreFileBatchOutput(input) {
    return {
        id: input.id,
        object: input.object,
        createdAt: new Date(input.created_at),
...
export function convertOpenAIPageableListOfVectorStoreFileOutput(input) {
    return {
        object: input.object,
        firstId: input.first_id,
        lastId: input.last_id,
...
export function convertVectorStoreFileOutput(input) {
    return {
        id: input.id,
        object: input.object,
        usageBytes: input.usage_bytes,
...
export function convertVectorStoreFileDeletionStatusOutput(input) {
    return {
        id: input.id,
        deleted: input.deleted,
        object: input.object,
...
export function convertOpenAIFileOutput(input) {
    return {
        id: input.id,
        object: input.object,
        bytes: input.bytes,
...
export function convertFileListResponseOutput(input) {
    return {
        object: input.object,
...
export function convertMessageDeltaChunkOutput(input) {
    return {
        id: input.id,
        object: input.object,
...
export function convertRunStepDeltaChunk(input) {
    return {
        id: input.id,
        object: input.object,
